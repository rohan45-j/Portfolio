...
<head>
        ...
        <title>JR WebTech - Personal Portfolio HTML5 Template</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="shortcut icon" type="image/x-icon" href="front_end_assets/img/ZJfav.PNG">
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none"><img src="front_end_assets/img/logo/rrlogo.png" height=90 width=90 alt="Logo"></a>
                                    <a href="index.php" class="navbar-brand s-logo-none"><img src="front_end_assets/img/logo/S-jrlogo (2).png" height=90 width=90 alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                    <a href="index-2.html">
                        <img src="front_end_assets/img/logo/rrlogo.png" height=80 width=90 alt="" />
                    </a>
                </div>
        ...
        <main>
                    ...
                    ?>
                      ...
                      <div class="speaker-box">
      								...
      								<div class="speaker-overlay">
      									...
      									<a href="https://github.com/rohan45-j" class="arrow-btn">More information <span></span></a>
      								</div>
      							</div>
                  </div>
          ...
          ?>
            ...
            <div class="barnd-area pt-100 pb-100">
                <div class="container">
                <div class="section-title text-center mb-70">
                                <span>Skills Website</span>
                                <h2>Happy Website quotes</h2>
                            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p><?=date("Y")?> © Md. Zillur Rahaman (Rohan) | All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
